...
export default function AddFooterSectionPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        showSuccess("Footer section added successfully!");
        ...
        showError(result.error || "Failed to add footer section");
      }
    } catch (error) {
    ...
    <div className="h-full p-4 sm:p-5 md:p-6 bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-gray-600 dark:text-white/70 transition-colors duration-300">
          Create a new footer section for mobile, tablet, or desktop views
        </p>
      </div>
