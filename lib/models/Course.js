...
const courseSchema = new mongoose.Schema(
  {
    ...
    averageFee: {
      type: Number,
      default: null,
      min: [0, "Average fee cannot be negative"],
    },
    averageFeeCurrency: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Currency",
      ...
      validate: {
        validator: function (value) {
          return this.averageFee === null || this.averageFee === undefined || Boolean(value);
        },
        message: "Average fee currency is required when average fee is provided",
      },
    },
