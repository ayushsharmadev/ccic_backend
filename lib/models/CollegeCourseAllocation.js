...
collegeCourseAllocationSchema.index({ "assignedCourses.examType": 1 });
collegeCourseAllocationSchema.index({ "assignedCourses.isActive": 1 });
collegeCourseAllocationSchema.index({
  "assignedCourses.isActive": 1,
  "assignedCourses.course": 1,
});
collegeCourseAllocationSchema.index({
  "assignedCourses.isActive": 1,
  "assignedCourses.examType": 1,
});
